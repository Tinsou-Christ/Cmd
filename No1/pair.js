...
module.exports = {
  ...
  onStart: async function ({ api, event, args, usersData, threadsData }) {
    ...
    const processingMsg = await api.sendMessage("💫 Création de votre carte romantique...", event.threadID);
    ...
    try {
      ...
      try { await api.unsendMessage(processingMsg.messageID); } catch (_) {}
